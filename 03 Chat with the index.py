...
# MAGIC     `year` (1900-2100), `month` (1-12). Example: 
# MAGIC     """
# MAGIC )
# MAGIC # ---------------------------------------------------------------------------
